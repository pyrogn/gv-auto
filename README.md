...
В чистом ZPG-режиме (без скриптом, но с ежедневными посещениями) 1000 кирпичей собирается около года. Это 3 кирпича в день (квесты, рыбалка, покупка). Скрипт работал по 8-12 часов в день.
...
Дуэлей: 19 (соперник находился в 50% отправок на дуэль)
